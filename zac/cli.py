...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="EN: Path to requirements JSON file. "
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="EN: Path to module library JSON file. "
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="EN: Output JSON path for selected architecture. "
             "TR: Seçilen mimarinin yazılacağı çıktı JSON yolu.",
    )

    args = parser.parse_args()

    requirements = loader.load_requirements(args.requirements)
    module_library = loader.load_module_library(args.modules)
